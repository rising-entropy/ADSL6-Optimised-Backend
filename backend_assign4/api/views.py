...
class StudentsAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = Student.objects.select_related("department").all()
            allList = []
...
class DepartmentAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = Department.objects.all()
            allList = []
            for instance in allInstances:
...
class InstructorAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = Instructor.objects.select_related("department").all()
            allList = []
            for instance in allInstances:
...
class AdvisorAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = Advisor.objects.select_related("student", "instructor").all()
            allList = []
            for instance in allInstances:
...
class CourseAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = Course.objects.select_related("department").all()
            allList = []
            for instance in allInstances:
...
class PrerequisitesAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = Course.objects.select_related("course", "prereq").all()
            allList = []
            for instance in allInstances:
...
class ClassroomAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = Classroom.objects.all()
            allList = []
            for instance in allInstances:
...
class TimeSlotAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = TimeSlot.objects.all()
            allList = []
            for instance in allInstances:
...
class SectionAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = Section.objects.select_related("course", "classroom", "timeSlot").all()
            allList = []
            for instance in allInstances:
...
class StudentTakesSectionAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = StudentTakesSection.objects.select_related("section", "student").all()
            allList = []
            for instance in allInstances:
...
class InstructorTeachesSectionAPI(APIView):
    def get(self, request):
        try:
            ...
            allInstances = StudentTakesSection.objects.select_related("instructor", "section").all()
            allList = []
            for instance in allInstances:
